...
//オブジェクトの追加
addMeshC(vts1, index1, {meshcolor:0xff6600, flatshade:true});
addMeshC(vts2, index1, {meshcolor:0x0044ff, flatshade:true});
addMeshC(vts3, index1, {meshcolor:0xff0000, flatshade:true});
addMeshC(vts4, index1, {meshcolor:0x44dd00, flatshade:true});
addMeshC(vts5, index1, {meshcolor:0xffff47, flatshade:true});

addTubeC(vtsall, edge1, 0.1, {color:0x7ad3ff});
