...
addMeshC(vts1, index1[1], {scale:sc1, color:0x00ff77, flatshade:true, rotation:rt1});
addMeshC(vts1, index1[2], {scale:sc1, color:0x7700ff, flatshade:true, rotation:rt1});
addMeshC(vts1, index1[3], {scale:sc1, color:0xff7700, flatshade:true, rotation:rt1});

addMeshC(vts2, index2[0], {scale:sc1, color:0xff0077, flatshade:true, rotation:rt1, opacity:0.1});
addMeshC(vts2, index2[1], {scale:sc1, color:0x00ff77, flatshade:true, rotation:rt1, opacity:0.1});
addMeshC(vts2, index2[2], {scale:sc1, color:0x7700ff, flatshade:true, rotation:rt1, opacity:0.1});
addMeshC(vts2, index2[3], {scale:sc1, color:0xff7700, flatshade:true, rotation:rt1, opacity:0.1});
